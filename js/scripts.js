...
document.addEventListener('DOMContentLoaded', function () {
	...
	const clientsSliders = [],
		clients = document.querySelectorAll('.about_block .swiper')
	...
	let fullWidthSlider = document.querySelector('.full_w_slider .swiper')

	if (fullWidthSlider) {
		new Swiper('.full_w_slider .swiper', {
			loop: true,
			speed: 750,
			watchSlidesProgress: true,
			slideActiveClass: 'active',
	...
	$('.product_info .colors label').click(function() {
		$(this).closest('.colors').find('.label span').text($(this).data('name'))
	})
	...
	// Товар в избранное
	$('.product .favorite_btn, .product_info .favorite_btn, .cart_info table td.action .favorite_btn').click(function(e) {
		e.preventDefault()
